...
class FruitFusionGame {
    ...
    handleFruitCollision(fruit1, fruit2) {
        ...
        if (distance < minDistance && distance > 0) {
            ...
            // Mobile-specific calm collision
            ...
            // Calmer collision on mobile
            const restitution = this.isMobile ? this.restitution * 0.5 : this.restitution;
            ...
            // Apply damping factor for mobile
            const dampingFactor = this.isMobile ? 0.7 : 1.0;
