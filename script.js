class FruitMergeGame {
    constructor() {
        ...
        this.maxBubbles = this.isMobile ? 1 : 3; // Minimal bubbles on mobile
        this.frameCount = 0;
        this.targetFPS = 60; // Same FPS for both mobile and desktop
        this.frameInterval = 1000 / this.targetFPS;
        this.lastFrameTime = 0;
        this.skipPhysicsFrames = 1; // No physics skipping - causes lag feeling
    ...
    gameLoop(currentTime = 0) {
        // Run at full frame rate for smooth experience
        this.updatePhysics();
        this.render();
        this.frameCount++;
